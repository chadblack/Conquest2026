...
For this assignment, we'll highlight the way that Historians read by applying our approach to a general audience article in the form of Charles Mann's "1491"[^1] We'll read and analyze it as historians in part to see what differentiates academic from popular scholarship. Structure your write-up using [the form of a précis and memo](https://chadblack.net/Conquest2026/resources/how%20to%20write%20a%20precis%20and%20memo/). In your concluding paragraph, explain what would be different if this piece were written for an academic journal. You may use any readings assigned in the course to help think though your critique.  **Do not include any additional resources or references. If you use them and cite them, you'll get a Fail. If you use them and don't cite them, you'll be referred for plagiarism!** 
...
[^1]: Charles Mann, "1491," *The Atlantic Monthly* (March 2002). 
